...
![A screenshot of the game which shows off the boosted mode on hard difficulty and the hint tile](images/boost.png)
...
![A screenshot of the installer in action.](images/installer.png)
...
![The in-game menu](images/in_game_menu.png) ![The game form](images/game.png) 
...
![The "Name" form](images/your_name.png)
...
![A pop up notifying the player that he unlocked an achievement](images/unlock_achiev.png)
...
![The second chance form](images/spinning_wheel.png)
...
![A gif that showcases the animations in the main menu](images/button_animations.gif)
