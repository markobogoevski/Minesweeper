...
![A screenshot of the game which shows off the boosted mode on hard difficulty and the hint tile](images/boost.PNG "Boosted mode and the hint tile on hard difficulty")
...
![A screenshot of the installer in action.](images/installer.PNG "The installer")

## Quick guide
The moment the application starts, the main menu appears with four main buttons and three options.

![The main menu](images/main_menu.PNG "The main menu")
...
![The in-game menu](images/in_game_menu.png "In-game menu") ![The game form](images/game.PNG "The game form, showing off the flags, question marks and the hint option")
...
![The "Name" form](images/your_name.PNG "Made it in the leaderboards!")
...
![The second chance form](images/spinning_wheel.PNG "Spinning wheel form in action")
...
![The "Achievements & Skins" form with all achievements unlocked](images/achievements.PNG "Achievements unlocked")
![The "Achievements & Skins" form showing off locked achievements and on hover label option](images/achievements_locked.PNG "Achievements locked, on hover info")
...
![The leaderboards form](images/leaderboards.PNG "The leaderboards")
...
![A gif that showcases the animations in the main menu](images/button_animations.gif "Button animations")
